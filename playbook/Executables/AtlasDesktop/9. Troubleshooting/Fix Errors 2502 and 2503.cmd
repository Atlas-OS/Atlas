...
goto AtlasLauncherParseArguments
:AtlasLauncherRun
"%AtlasNativePowerShell%" -NoProfile -NoLogo -ExecutionPolicy Bypass -File "%AtlasWindowsRoot%\AtlasModules\Scripts\Invoke-Toggle.ps1" -Name "FixErrors2502and2503" -State "Run" -LauncherPath "%~f0" %AtlasLauncherSilent% %AtlasLauncherJustContext% %AtlasLauncherNoAction%
if errorlevel 0 (
