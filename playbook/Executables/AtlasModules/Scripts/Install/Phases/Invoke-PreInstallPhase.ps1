...
$legacyMigration = Join-Path $scriptsRoot 'Install\Compat\Remove-AtlasLegacyElevationArtifacts.ps1'
...
try {
    $diskCleanup = Join-Path $scriptsRoot 'Install\Tasks\Invoke-DiskCleanup.ps1'
