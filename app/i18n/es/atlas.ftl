...
diagnostics-privacy = Los registros incluyen nombres de cuenta, rutas de archivos y datos del dispositivo. Revisa el ZIP y compártelo en privado con el soporte de Atlas. No se sube nada automáticamente.
