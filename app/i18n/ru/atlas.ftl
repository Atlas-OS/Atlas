...
diagnostics-privacy = Журналы содержат имена учётных записей, пути к файлам и данные устройств. Проверьте ZIP и отправьте его поддержке Atlas лично. Автоматическая отправка не выполняется.
