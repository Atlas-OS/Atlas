...
Любой желающий имеет доступ к брендовому набору Atlas—вы можете скачать его [здесь](https://github.com/Atlas-OS/branding/archive/refs/heads/main.zip) и сделать что-то потрясающее!
