⚠️Примечание: это переведенная версия оригинала. [README.md](https://github.com/Atlas-OS/Atlas/blob/main/README.md), Информация здесь может быть неточной и устаревшей.
<h1 align="center">
