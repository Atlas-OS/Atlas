...
bcdedit /set description REFINEDOS 22H2
...
echo This log keeps track of which scripts have been run. This is never transfered to an online resource and stays local. > !windir!\REFINEDOSModules\logs\userScript.log
echo -------------------------------------------------------------------------------------------------------------------- >> !windir!\REFINEDOSModules\logs\userScript.log