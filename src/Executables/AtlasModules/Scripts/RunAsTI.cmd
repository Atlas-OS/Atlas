...
if "%~1" == "" (
	...
	if "!program_path!" == "" echo error: failed && timeout /t 3 > nul && exit /b
    if exist "!program_path!\*" echo error: !program_path! is a folder && timeout /t 3 > nul && exit /b
...
if %RunAsTI_Errorlevel%==1 (goto RunAsTI-Fail) else (if %RunAsTI_Errorlevel%==2 (goto RunAsTI-Declined) else (exit /b 0))
