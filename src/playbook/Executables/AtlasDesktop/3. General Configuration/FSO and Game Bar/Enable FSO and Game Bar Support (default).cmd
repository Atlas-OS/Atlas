...
(
    reg delete "HKCU\System\GameConfigStore" /v "GameDVR_DSEBehavior" /f > nul
    ...
    reg delete "HKCU\System\GameBar" /v "GamePanelStartupTipIndex" /f > nul
    reg delete "HKCU\System\GameBar" /v "ShowStartupPanel" /f > nul
    reg delete "HKCU\System\GameBar" /v "UseNexusForGameBarEnabled" /f > nul
    ...
    reg delete "HKLM\SOFTWARE\Policies\Microsoft\Windows\GameDVR" /f > nul
    ...
    reg delete "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\GameDVR" /v "AppCaptureEnabled" /f > nul
) > nul
