...
if %errorlevel%==1 (
	call "%windir%\AtlasDesktop\3. Core Configuration\Power\Hibernation\Disable Hibernation (default).cmd" /silent
) else (
	call "%windir%\AtlasDesktop\3. Core Configuration\Power\Hibernation\Enable Hibernation.cmd" /silent
)
