...
if %errorlevel%==1 (
	call "%windir%\AtlarDesktop\3. General Configuration\Hibernation\Disable Hibernation (default).cmd" /silent
) else (
	call "%windir%\AtlarDesktop\3. General Configuration\Hibernation\Enable Hibernation.cmd" /silent
)
