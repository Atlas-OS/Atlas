...
reg add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\UserAccountControlSettings.exe" /v "Debugger" /t REG_SZ /d "\"C:\Users\Default\Desktop\Atlas\3. Configuration\1. General Configuration\User Account Control (UAC)\Enable UAC.cmd (default)\" /uacSettings" /f > nul 2>&1
